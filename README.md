# Perrin_Brownian_Motion: Script to Analyse Jean Perrin's Brownian Motion Data
A simple script to calculate the mean square deviations in the brownian motion trajectories measured by Jean Perrin, plot the MSD by the interval time and estimate the Avogadro's number by means of the Einstein's relation.
